...
@Autonomous(name="Garage Short Auto", group="Linear Opmode")

public class Autonomouse20 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        bottomLeftMotor.setPower(0.10); // Robot turns
        topLeftMotor.setPower(-0.10);
        bottomRightMotor.setPower(0.10);
        topRightMotor.setPower(-0.10);
        sleep(1000);
    }
}